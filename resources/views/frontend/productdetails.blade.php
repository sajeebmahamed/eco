	...
	<div class="page-area product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<figure>
						<img class="product-big-img" src="{{asset('uploads/product_photos')}}/{{ $singleproductinfo -> product_image }}" alt="">
					</figure>
					<div class="product-thumbs">
						<div class="product-thumbs-track">
							<div class="pt" data-imgbigurl="{{asset('frontend_assets/img/product/1.jpg')}}"><img src="{{asset('uploads/product_photos')}}/{{ $singleproductinfo -> product_image }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{asset('frontend_assets/img/product/2.jpg')}}"><img src="{{asset('uploads/product_photos')}}/{{ $singleproductinfo -> product_image }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{asset('frontend_assets/img/product/3.jpg')}}"><img src="{{asset('uploads/product_photos')}}/{{ $singleproductinfo -> product_image }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{asset('frontend_assets/img/product/4.jpg')}}"><img src="{{asset('uploads/product_photos')}}/{{ $singleproductinfo -> product_image }}" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="product-content">
						...
						<h6>Category Name : {{$singleproductinfo->relationtocategory->category_name}}</h6>
						<div class="pc-meta">
						...
						<p>{{$singleproductinfo-> product_des}}</p>
